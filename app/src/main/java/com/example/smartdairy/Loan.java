...
public class Loan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refreshLayout = findViewById(R.id.loan_swipe_to_refresh);
        countText = findViewById(R.id.loan_count_text);
        userID = SaveSharedPreference.getUserName(Loan.this);
        ...
        ImageButton button= findViewById(R.id.loan_search_date);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(Loan.this, date, myCalendar
    ...
    private void AddUserMilkData() {
        ...
        try {
            ...
            else
            {
                ...
                Log.i("jdbc",userID);
                String query = "select LoanAmount,Date from dbo.loan_table where UID="+userID+" ORDER BY Ind DESC";
                ...
                while (rs.next()){
                    ...
                    datanum.add(rs.getString("LoanAmount"));
        ...
        mAdapter = new MyLoanAdapter(data);
        recyclerView.setAdapter(mAdapter);

        countText.setText(count.toString()+" Items");
        if(count.equals(0))
        {
            new AlertDialog.Builder(Loan.this)
                    .setTitle("No Data")
    ...
    private void GetSearchedDateData() {
        ...
        try {
            ...
            else
            {
                ...
                Log.i("jdbc","connected");
                Log.i("jdbc",userID);
                String query = "select LoanAmount,Date from dbo.loan_table from dbo.loan_table where UID="+userID+" and Date='"+searchdate+"' ORDER BY Ind DESC";
                Statement stmt = connect.createStatement();
                ResultSet rs = stmt.executeQuery(query);
                while (rs.next()){
                    count++;
